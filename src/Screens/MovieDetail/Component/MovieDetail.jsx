...
export default function MovieDetail(props) {
    ...
    function addFafourite(e, value) {
		e.preventDefault();
		if (props.userdata) {
			props.setfavourite(value)
			props.movielike()
		} else
			history.push('/Signin')
	}
					...
					<div className="row">
						<div className="row col-12">
							...
							<div className="col-1" style={{ marginTop: 10 }}>
								{
									props.favourite === 0 ?
										<a href=""><img src='/img/heart-icon.png' onClick={(e) => addFafourite(e, 1)} alt="" /></a>
										: <a href=""><img src='/img/heart-icon-select.png' onClick={(e) => addFafourite(e, 0)} alt="" /></a>
						...
						<div className="col-12">
							<div className="col-12  card__description">
								<div style={{color:'white'}} dangerouslySetInnerHTML={{ __html: ssss }} />
							</div>
						</div>
					</div>
				</div>
