$(document).ready(function () {
	...
	$('.cc__nav--next').on('click', function() {
		$('.cc__carousel').trigger('next.owl.carousel');
	});
	$('.cc__nav--prev').on('click', function() {
		$('.cc__carousel').trigger('prev.owl.carousel');
	});
